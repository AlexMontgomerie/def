...
HD_PWD='/home/alex/DSAM2/hw/impl/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log deaf_encoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source deaf_encoder.tcl -notrace
