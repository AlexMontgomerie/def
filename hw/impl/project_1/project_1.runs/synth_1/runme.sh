...
HD_PWD='/home/alex/DSAM2/hw/impl/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log deaf_encoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source deaf_encoder.tcl
